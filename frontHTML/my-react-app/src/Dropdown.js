...
class Dropdown extends Component {
    ...
    constructor(props){
        super(props);
        this.state = {courses : ['Angular', 'React', 'Ember','Vue'], showFlag: false, caption: null}
    }
    ...
    render() {
        ...
        let courseList = this.state.courses.map((course, i)=> {
            ...
            // <a className="dropdown-item" onClick ={this.handleItemClick.bind(this,course)} key={i} >{course}</a>
        })
